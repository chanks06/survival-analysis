...
summary(km.genfan)
ggsurvplot(fit = km.genfan, data = genfan, palete = "forestgreen", risk.table = F, conf.int = T) + 
...
```
*ANSWER:* Estimate for rate parameter is 16670.93
...
summary(lnorm.fit)
```
*ANSWER:* location estimate: 10.146, sd estiamte: 1.681. 
...
```
*ANSWER:* The probability of a given diesel fan failing in warranty is .027.