...
#creating left and right columns for ds 
ds = ds %>% 
...
**ANSWER:** Based on the plot above, the model is a good match for the data because the model survival curves closely follow the survival curves produced by actual observations. 
